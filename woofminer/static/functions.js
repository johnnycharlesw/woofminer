...
/** Verify current Woofminer version
* @param string
...
function verifyVersion(current, url, token) {
	...
	iframe.src = 'https://www.github.com/johnnycharlesw/woofminer/wiki/version/?current=' + current;
	...
	addEventListener('message', event => {
		if (event.origin == 'https://www.github.com/johnnycharlesw/woofminer/wiki') {
