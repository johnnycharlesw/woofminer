...
if ($_GET["file"] == "default.css") {
	...
	echo lzw_decompress(compile_file('../woofminer/static/default.css;../externals/jush/jush.css', 'minify_css'));
} elseif ($_GET["file"] == "dark.css") {
	header("Content-Type: text/css; charset=utf-8");
	echo lzw_decompress(compile_file('../woofminer/static/dark.css;../externals/jush/jush-dark.css', 'minify_css'));
} elseif ($_GET["file"] == "functions.js") {
	header("Content-Type: text/javascript; charset=utf-8");
	echo lzw_decompress(compile_file('../woofminer/static/functions.js;static/editing.js', 'minify_js'));
...
../externals/jush/modules/jush-simpledb.js', 'minify_js'));
	...
	echo compile_file('../woofminer/static/logo.png');
}
exit;
