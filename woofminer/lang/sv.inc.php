...
Lang::$translations = array(
	...
	'Thanks for using Woofminer, consider <a href="https://www.github.com/johnnycharlesw/woofminer/wiki/en/donation/">donating</a>.' => 'Tack för att du använder Woofminer, vänligen fundera över att <a href="https://www.github.com/johnnycharlesw/woofminer/wiki/en/donation/">donera</a>.',
	...
	'Woofminer does not support accessing a database without a password, <a href="https://www.github.com/johnnycharlesw/woofminer/wiki/en/password/"%s>more information</a>.' => 'Woofminer tillåter inte att ansluta till en databas utan lösenord. <a href="https://www.github.com/johnnycharlesw/woofminer/wiki/en/password/"%s>Mer information</a>.',
	...
	'Master password expired. <a href="https://www.github.com/johnnycharlesw/woofminer/wiki/en/extension/"%s>Implement</a> %s method to make it permanent.' => 'Huvudlösenordet har löpt ut. <a href="https://www.github.com/johnnycharlesw/woofminer/wiki/en/extension/"%s>Implementera</a> %s en metod för att göra det permanent.',
	'Language' => 'Språk',
	'Invalid CSRF token. Send the form again.' => 'Ogiltig CSRF-token. Skicka formuläret igen.',
	'If you did not send this request from Woofminer then close this page.' => 'Om du inte skickade en förfrågan från Woofminer så kan du stänga den här sidan.',
