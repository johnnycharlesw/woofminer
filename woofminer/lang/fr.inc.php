...
Lang::$translations = array(
	...
	'Master password expired. <a href="https://www.github.com/johnnycharlesw/woofminer/wiki/en/extension/"%s>Implement</a> %s method to make it permanent.' => 'Le mot de passe a expiré. <a href="https://www.github.com/johnnycharlesw/woofminer/wiki/en/extension/"%s>Implémentez</a> la méthode %s afin de le rendre permanent.',
	...
	'If you did not send this request from Woofminer then close this page.' => 'Si vous n\'avez pas envoyé cette requête depuis Woofminer, alors fermez cette page.',
	...
	'Woofminer does not support accessing a database without a password, <a href="https://www.github.com/johnnycharlesw/woofminer/wiki/en/password/"%s>more information</a>.' => 'Woofminer ne supporte pas l\'accès aux bases de données sans mot de passe, <a href="https://www.github.com/johnnycharlesw/woofminer/wiki/en/password/"%s>plus d\'information</a>.',
