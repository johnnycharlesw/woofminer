...
Lang::$translations = array(
	...
	'Thanks for using Woofminer, consider <a href="https://www.github.com/johnnycharlesw/woofminer/wiki/en/donation/">donating</a>.' => 'Woofminer kullandığınız için teşekkür ederiz <a href="https://www.github.com/johnnycharlesw/woofminer/wiki/en/donation/">bağış yapmayı düşünün</a>.',
	...
	'Master password expired. <a href="https://www.github.com/johnnycharlesw/woofminer/wiki/en/extension/"%s>Implement</a> %s method to make it permanent.' => 'Ana şifrenin süresi doldu. Kalıcı olması için <a href="https://www.github.com/johnnycharlesw/woofminer/wiki/en/extension/"%s>%s medodunu</a> kullanın.',
	'Language' => 'Dil',
	'Invalid CSRF token. Send the form again.' => 'Geçersiz (CSRF) jetonu. Formu tekrar yolla.',
	'If you did not send this request from Woofminer then close this page.' => 'Bu isteği Woofminer\'den göndermediyseniz bu sayfayı kapatın.',
