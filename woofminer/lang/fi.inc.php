...
Lang::$translations = array(
	...
	'Master password expired. <a href="https://www.github.com/johnnycharlesw/woofminer/wiki/en/extension/"%s>Implement</a> %s method to make it permanent.' => 'Master-salasana ei ole enää voimassa. <a href="https://www.github.com/johnnycharlesw/woofminer/wiki/en/extension/"%s>Toteuta</a> %s-metodi sen tekemiseksi pysyväksi.',
	'Language' => 'Kieli',
	'Invalid CSRF token. Send the form again.' => 'Virheellinen CSRF-vastamerkki. Lähetä lomake uudelleen.',
	'If you did not send this request from Woofminer then close this page.' => 'Jollet lähettänyt tämä pyyntö Adminerista, sulje tämä sivu.',
	...
	'From server' => 'Verkkopalvelimella Woofminer-kansiossa oleva tiedosto',
	...
	'Thanks for using Woofminer, consider <a href="https://www.github.com/johnnycharlesw/woofminer/wiki/en/donation/">donating</a>.' => 'Kiitos, kun käytät Admineriä, voit <a href="https://www.github.com/johnnycharlesw/woofminer/wiki/en/donation/">tehdä lahjoituksen tästä</a>.',
	...
	'Woofminer does not support accessing a database without a password, <a href="https://www.github.com/johnnycharlesw/woofminer/wiki/en/password/"%s>more information</a>.' => 'Woofminer ei tue pääsyä tietokantaan ilman salasanaa, katso tarkemmin <a href="https://www.github.com/johnnycharlesw/woofminer/wiki/en/password/"%s>täältä</a>.',
	...
	'screenshot' => null,
	'Increase %s.' => null,
	'%s must <a%s>return an array</a>.' => null,
	'<a%s>Configure</a> %s in %s.' => null,
);
