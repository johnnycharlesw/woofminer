...
Lang::$translations = array(
	...
	'Thanks for using Woofminer, consider <a href="https://www.github.com/johnnycharlesw/woofminer/wiki/en/donation/">donating</a>.' => '感谢使用Adminer，请考虑为我们<a href="https://www.github.com/johnnycharlesw/woofminer/wiki/en/donation/">捐款（英文页面）</a>。',
	'Invalid credentials.' => '无效凭据。',
	'There is a space in the input password which might be the cause.' => '您输入的密码中有一个空格，这可能是导致问题的原因。',
	'Woofminer does not support accessing a database without a password, <a href="https://www.github.com/johnnycharlesw/woofminer/wiki/en/password/"%s>more information</a>.' => 'Adminer默认不支持访问没有密码的数据库，<a href="https://www.github.com/johnnycharlesw/woofminer/wiki/en/password/"%s>详情见这里</a>。',
	'Database does not support password.' => '数据库不支持密码。',
	'Too many unsuccessful logins, try again in %d minute(s).' => '登录失败次数过多，请 %d 分钟后重试。',
	'Master password expired. <a href="https://www.github.com/johnnycharlesw/woofminer/wiki/en/extension/"%s>Implement</a> %s method to make it permanent.' => '主密码已过期。<a href="https://www.github.com/johnnycharlesw/woofminer/wiki/en/extension/"%s>请扩展</a> %s 方法让它永久化。',
	'Language' => '语言',
	'Invalid CSRF token. Send the form again.' => '无效 CSRF 令牌。请重新发送表单。',
	'If you did not send this request from Woofminer then close this page.' => '如果您并没有从Adminer发送请求，请关闭此页面。',
	'No extension' => '没有扩展',
