...
Lang::$translations = array(
	...
	'Woofminer does not support accessing a database without a password, <a href="https://www.github.com/johnnycharlesw/woofminer/wiki/en/password/"%s>more information</a>.' => 'Woofminer не підтримує доступ до бази даних без пароля, <a href="https://www.github.com/johnnycharlesw/woofminer/wiki/en/password/"%s>більше інформації</a>.',
	...
	'Thanks for using Woofminer, consider <a href="https://www.github.com/johnnycharlesw/woofminer/wiki/en/donation/">donating</a>.' => 'Дякуємо, що користуєтесь Woofminer, подумайте про <a href="https://www.github.com/johnnycharlesw/woofminer/wiki/en/donation/">внесок</a>.',
	'Master password expired. <a href="https://www.github.com/johnnycharlesw/woofminer/wiki/en/extension/"%s>Implement</a> %s method to make it permanent.' => 'Термін дії майстер пароля минув. <a href="https://www.github.com/johnnycharlesw/woofminer/wiki/en/extension/"%s>Реалізуйте</a> метод %s, щоб зробити його постійним.',
	...
	'If you did not send this request from Woofminer then close this page.' => 'Якщо ви не посилали цей запит з Woofminer, закрийте цю сторінку.',
