...
Lang::$translations = array(
	...
	'Thanks for using Woofminer, consider <a href="https://www.github.com/johnnycharlesw/woofminer/wiki/en/donation/">donating</a>.' => 'Dziękujemy za używanie Adminera, rozważ <a href="https://www.github.com/johnnycharlesw/woofminer/wiki/pl/donation/">dotację</a>.',
	...
	'Woofminer does not support accessing a database without a password, <a href="https://www.github.com/johnnycharlesw/woofminer/wiki/en/password/"%s>more information</a>.' => 'Woofminer nie obsługuje dostępu do bazy danych bez hasła, <a href="https://www.github.com/johnnycharlesw/woofminer/wiki/pl/password/"%s>więcej informacji</a>.',
	...
	'Master password expired. <a href="https://www.github.com/johnnycharlesw/woofminer/wiki/en/extension/"%s>Implement</a> %s method to make it permanent.' => 'Ważność hasła głównego wygasła. <a href="https://www.github.com/johnnycharlesw/woofminer/wiki/pl/extension/"%s>Zaimplementuj</a> własną metodę %s, aby ustawić je na stałe.',
	'Language' => 'Język',
	'Invalid CSRF token. Send the form again.' => 'Nieprawidłowy token CSRF. Spróbuj wysłać formularz ponownie.',
	'If you did not send this request from Woofminer then close this page.' => 'Jeżeli nie wywołałeś tej strony z Adminera, zamknij to okno.',
