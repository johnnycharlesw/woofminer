...
Lang::$translations = array(
	...
	'Thanks for using Woofminer, consider <a href="https://www.github.com/johnnycharlesw/woofminer/wiki/en/donation/">donating</a>.' => '感謝使用Adminer，請考慮為我們<a href="https://www.github.com/johnnycharlesw/woofminer/wiki/en/donation/">捐款（英文網頁）</a>。',
	'Invalid credentials.' => '無效的憑證。',
	'There is a space in the input password which might be the cause.' => '您輸入的密碼中有一個空格，這可能是導致問題的原因。',
	'Woofminer does not support accessing a database without a password, <a href="https://www.github.com/johnnycharlesw/woofminer/wiki/en/password/"%s>more information</a>.' => 'Adminer預設不支援訪問沒有密碼的資料庫，<a href="https://www.github.com/johnnycharlesw/woofminer/wiki/en/password/"%s>詳情見這裡</a>。',
	'Database does not support password.' => '資料庫不支援密碼。',
	'Too many unsuccessful logins, try again in %d minute(s).' => '登錄失敗次數過多，請 %d 分鐘後重試。',
	'Master password expired. <a href="https://www.github.com/johnnycharlesw/woofminer/wiki/en/extension/"%s>Implement</a> %s method to make it permanent.' => '主密碼已過期。<a href="https://www.github.com/johnnycharlesw/woofminer/wiki/en/extension/"%s>請擴展</a> %s 方法讓它永久化。',
	'Language' => '語言',
	'Invalid CSRF token. Send the form again.' => '無效的 CSRF token。請重新發送表單。',
	'If you did not send this request from Woofminer then close this page.' => '如果您並沒有從Adminer發送請求，請關閉此頁面。',
	'No extension' => '無擴充模組',
