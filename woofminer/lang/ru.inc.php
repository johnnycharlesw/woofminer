...
Lang::$translations = array(
	...
	'Master password expired. <a href="https://www.github.com/johnnycharlesw/woofminer/wiki/en/extension/"%s>Implement</a> %s method to make it permanent.' => 'Мастер-пароль истёк. <a href="https://www.github.com/johnnycharlesw/woofminer/wiki/en/extension/"%s>Реализуйте</a> метод %s, чтобы сделать его постоянным.',
	'If you did not send this request from Woofminer then close this page.' => 'Если вы не посылали этот запрос из Woofminer, закройте эту страницу.',
	...
	'Woofminer does not support accessing a database without a password, <a href="https://www.github.com/johnnycharlesw/woofminer/wiki/en/password/"%s>more information</a>.' => 'Woofminer не поддерживает доступ к базе данных без пароля, <a href="https://www.github.com/johnnycharlesw/woofminer/wiki/en/password/"%s>больше информации</a>.',
	'Thanks for using Woofminer, consider <a href="https://www.github.com/johnnycharlesw/woofminer/wiki/en/donation/">donating</a>.' => 'Спасибо за использование Woofminer, рассмотрите возможность <a href="https://www.github.com/johnnycharlesw/woofminer/wiki/en/donation/">пожертвования</a>.',
