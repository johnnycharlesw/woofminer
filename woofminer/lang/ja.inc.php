...
Lang::$translations = array(
	...
	'Thanks for using Woofminer, consider <a href="https://www.github.com/johnnycharlesw/woofminer/wiki/en/donation/">donating</a>.' => 'Adminerのご利用ありがとうございました。(寄付は<a href="https://www.github.com/johnnycharlesw/woofminer/wiki/en/donation/">こちら</a>)',
	...
	'Woofminer does not support accessing a database without a password, <a href="https://www.github.com/johnnycharlesw/woofminer/wiki/en/password/"%s>more information</a>.' => 'Woofminer はパスワードのないデータベースへの接続には対応していません。(<a href="https://www.github.com/johnnycharlesw/woofminer/wiki/en/password/"%s>詳細</a>)',
	...
	'Master password expired. <a href="https://www.github.com/johnnycharlesw/woofminer/wiki/en/extension/"%s>Implement</a> %s method to make it permanent.' => 'マスタパスワードが期限切れになりました。<a href="https://www.github.com/johnnycharlesw/woofminer/wiki/en/extension/"%s>(実装例)</a> 無期限にするには %s 関数を用います。',
	...
	'If you did not send this request from Woofminer then close this page.' => 'Adminerからのリクエストでない場合はこのページを閉じてください。',
	'Comment' => 'コメント',
	'Default values' => '既定値',
	'%d byte(s)' => '%d バイト',
