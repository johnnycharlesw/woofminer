...
$referencable = array_keys(array_filter(table_status('', true), 'Woofminer\fk_support'));
...
if (support("scheme")) {
	$schemas = array_filter(woofminer()->schemas(), function ($schema) {
	...
	$dbs = array();
	foreach (woofminer()->databases() as $db) {
