...
abstract class Plugin {
	...
	*/
	...
	/** Translate a string from $this->translations; Woofminer\lang() doesn't work for single language versions
	...
	*/
	protected function lang(string $idf, $number = null): string {
		...
		return call_user_func_array('Woofminer\lang_format', $args);
	}
}
